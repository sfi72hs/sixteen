...
set key t r;
set xra[0:300]
file0='IdotI_b'.b.'r'.r.'d'.d1.'a'.a0.'k'.k.'_si.dat';
file2='IdotI_b'.b.'r'.r.'d'.d2.'a'.a0.'k'.k.'_si.dat';
file1='IdotI_b'.b.'r'.r.'d'.d.'a'.a0.'k'.k.'_si.dat';

set xlabel ' t'
set ylabel 'dI/I'

#set terminal postscript eps enhanced color font 'Times-Roman,24';out_file='../images/IdotI_b'.b.'r'.r.'d'.d.'k'.k.'_si.eps';set output out_file;
set key t r;

plot file0 tit '{/Symbol D}=1' ls 13,\
     file2 tit '{/Symbol D}=0.5 ' ls 15,\
     file1 tit '{/Symbol D}=0' ls 14
